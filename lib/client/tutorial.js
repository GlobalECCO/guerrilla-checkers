define(['underscore', 'lib/checkers'], function(_, Checkers) {
  ...
  function Tutorial() {
    ...
    self.textGuerrillaPieces2 = 'After the initial piece, Guerrilla pieces must be placed next to previously placed pieces.';
    ...
    self.textEndGame = 'The game will end when the State player loses all of its pieces (Guerrilla victory) or the Guerilla player loses all its pieces or runs out of pieces to place (State victory).';
      ...
      self.script = [
        ...
        [{
          ...
          tip: {
            ...
            content: self.textGuerrillaPieces + '  ' + self.textGuerrillaPieces2,
            tipJoint: 'top'
          },
        ...
        {
          el: '#soldier_moves > .soldier_shadow:eq(1)',
          tip: {
        ...
        // Step 5
        [{
          el: '#soldier_moves > .soldier_shadow:eq(0)',
          tip: {
        ...
        // Step 7
        [{
          el: '#soldier_moves > .soldier_shadow:eq(2)',
          tip: {
            content: 'Click here to move the piece.',
            tipJoint: 'left'
          },
      ...
      self.script = [
        ...
        [{
          ...
          tip: {
            ...
            content: self.textGuerrillaPieces2,
            tipJoint: 'bottom'
          },
          action: null,
        },
